...
#line 98 "../kerwinCalculator/calc_yacc.c"
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_NUM = 3,                        /* NUM  */
  YYSYMBOL_OP_ADD = 4,                     /* OP_ADD  */
  YYSYMBOL_OP_SUB = 5,                     /* OP_SUB  */
  YYSYMBOL_OP_MUL = 6,                     /* OP_MUL  */
  YYSYMBOL_OP_DIV = 7,                     /* OP_DIV  */
  YYSYMBOL_END = 8,                        /* END  */
  YYSYMBOL_NEG = 9,                        /* NEG  */
  YYSYMBOL_OP_POW = 10,                    /* OP_POW  */
  YYSYMBOL_OP_FUN = 11,                    /* OP_FUN  */
  YYSYMBOL_LEFT_BRACKET = 12,              /* LEFT_BRACKET  */
  YYSYMBOL_RIGHT_BRACKET = 13,             /* RIGHT_BRACKET  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUM", "OP_ADD",
  "OP_SUB", "OP_MUL", "OP_DIV", "END", "NEG", "OP_POW", "OP_FUN",
  "LEFT_BRACKET", "RIGHT_BRACKET", "$accept", "line", "expr", "term",
  "factor", "fun", YY_NULLPTR
};
...
{
       3,     0,     1,    11,     0,     0,     0,     0,     6,    10,
      14,    13,     0,     0,     0,     0,     2,     0,     0,     0,
       0,    12,     4,     5,     7,     8,     9,    15
};
...
{
       2,    14,    15,     3,    12,     4,     3,    13,     4,     0,
      21,     5,     6,    20,     5,     6,    14,    15,    14,    15,
      22,    23,    16,    17,    18,    27,    11,    19,    24,    25,
      26
};

static const yytype_int8 yycheck[] =
{
       0,     4,     5,     3,    12,     5,     3,     6,     5,    -1,
      13,    11,    12,    12,    11,    12,     4,     5,     4,     5,
      14,    15,     8,     6,     7,    13,     3,    10,    17,    18,
      19
};
...
{
       0,    15,     0,     3,     5,    11,    12,    16,    17,    18,
      19,     3,    12,    16,     4,     5,     8,     6,     7,    10,
      16,    13,    17,    17,    18,    18,    18,    13
};
...
#line 43 "../kerwinCalculator/calc.y"
                  {
        //printf("%2f\n", $2);
        result = (yyvsp[-1].floatval);
        }
#line 1111 "../kerwinCalculator/calc_yacc.c"
    break;

  case 4: /* expr: expr OP_ADD term  */
#line 50 "../kerwinCalculator/calc.y"
                     {(yyval.floatval) = (yyvsp[-2].floatval) + (yyvsp[0].floatval);}
#line 1117 "../kerwinCalculator/calc_yacc.c"
    break;

  case 5: /* expr: expr OP_SUB term  */
#line 51 "../kerwinCalculator/calc.y"
                       {(yyval.floatval) = (yyvsp[-2].floatval) - (yyvsp[0].floatval);}
#line 1123 "../kerwinCalculator/calc_yacc.c"
    break;

  case 6: /* expr: term  */
#line 52 "../kerwinCalculator/calc.y"
           {(yyval.floatval)=(yyvsp[0].floatval);}
#line 1129 "../kerwinCalculator/calc_yacc.c"
    break;

  case 7: /* term: term OP_MUL factor  */
#line 55 "../kerwinCalculator/calc.y"
                       {(yyval.floatval) = (yyvsp[-2].floatval) * (yyvsp[0].floatval);}
#line 1135 "../kerwinCalculator/calc_yacc.c"
    break;

  case 8: /* term: term OP_DIV factor  */
#line 56 "../kerwinCalculator/calc.y"
                         {(yyval.floatval) = (yyvsp[-2].floatval) / (yyvsp[0].floatval);}
#line 1141 "../kerwinCalculator/calc_yacc.c"
    break;

  case 9: /* term: term OP_POW factor  */
#line 57 "../kerwinCalculator/calc.y"
                         {(yyval.floatval) = pow((yyvsp[-2].floatval),(yyvsp[0].floatval));}
#line 1147 "../kerwinCalculator/calc_yacc.c"
    break;

  case 10: /* term: factor  */
#line 58 "../kerwinCalculator/calc.y"
             {(yyval.floatval)=(yyvsp[0].floatval);}
#line 1153 "../kerwinCalculator/calc_yacc.c"
    break;

  case 11: /* factor: NUM  */
#line 61 "../kerwinCalculator/calc.y"
        {(yyval.floatval)=(yyvsp[0].floatval);}
#line 1159 "../kerwinCalculator/calc_yacc.c"
    break;

  case 12: /* factor: LEFT_BRACKET expr RIGHT_BRACKET  */
#line 62 "../kerwinCalculator/calc.y"
                                      {(yyval.floatval)=(yyvsp[-1].floatval);}
#line 1165 "../kerwinCalculator/calc_yacc.c"
    break;

  case 13: /* factor: OP_SUB NUM  */
#line 63 "../kerwinCalculator/calc.y"
                           {(yyval.floatval)=-(yyvsp[0].floatval);}
#line 1171 "../kerwinCalculator/calc_yacc.c"
    break;

  case 15: /* fun: OP_FUN LEFT_BRACKET expr RIGHT_BRACKET  */
#line 66 "../kerwinCalculator/calc.y"
                                           {
        if (strcmp("sin", (yyvsp[-3].id)) == 0)
        {
            (yyval.floatval)=sin((yyvsp[-1].floatval)* M_PI / 180);
        }else if (strcmp("cos", (yyvsp[-3].id)) == 0)
        {
            (yyval.floatval)=cos((yyvsp[-1].floatval)* M_PI / 180);
        }
        else if (strcmp("tan", (yyvsp[-3].id)) == 0)
        {
            (yyval.floatval)=tan((yyvsp[-1].floatval)* M_PI / 180);
        }else if (strcmp("asin", (yyvsp[-3].id)) == 0)
        {
            (yyval.floatval)=asin((yyvsp[-1].floatval))/ M_PI * 180;
