...
#line 65 "calc.y"
        ...
        {
            (yyval.floatval)=sin((yyvsp[-1].floatval)* PI / 180);
        }else if (strcmp("cos", (yyvsp[-3].id)) == 0)
        {
            (yyval.floatval)=cos((yyvsp[-1].floatval)* PI / 180);
        }
        else if (strcmp("tan", (yyvsp[-3].id)) == 0)
        {
            (yyval.floatval)=tan((yyvsp[-1].floatval)* PI / 180);
        }else{
            yyerror((yyvsp[-3].id));
